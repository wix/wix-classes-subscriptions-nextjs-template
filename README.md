...
Create a [new Wix Headless project](https://www.wix.com/intro/headlessreferralInfo=netlify_github_fitness). For instructions on creating a Wix project, see [Create a Wix Headless Project](https://dev.wix.com/docs/go-headless/getting-started/setup/general-setup/create-a-project).
