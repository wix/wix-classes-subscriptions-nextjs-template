# Wix Bookings Template: A Next.js Fitness Professional Site
...
For more information, see [How to Deploy Next.js Sites to Netlify](https://www.netlify.com/blog/2020/11/30/how-to-deploy-next.js-sites-to-netlify/) or view the demo [here](https://netlify.bookings-classes-demo.wix.dev/).

**Note** - In order to view the full flow in the demo site, use the coupon code `FREE` to book classes or `FREEPLAN` to purchase paid plans
